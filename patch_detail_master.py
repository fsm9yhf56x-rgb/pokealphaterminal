#!/usr/bin/env python3
"""Master set badge dans la page detail serie"""
...
# Remplacer le "return null" quand complete par un badge celebration
old = "                  if(missing2===0||total2===0) return null"
new = """                  if(total2===0) return null
