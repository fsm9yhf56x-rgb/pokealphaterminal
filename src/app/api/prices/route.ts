...
export async function GET(request: Request) {
  ...
  let query = supabase.from('prices').select('card_name, card_number, set_slug, set_name, ebay_avg, tcg_avg, top_price, tier, has_graded, psa10_avg, fetched_at, poketrace_id, variant')
