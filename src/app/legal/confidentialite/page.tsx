...
export default function Page() {
  return (
    <PublicDoc title="Politique de confidentialité" updated="13/07/2026">
      ...
      <h2>Mesure d’audience et amélioration du service</h2>
      <p>Afin d’améliorer et de sécuriser notre service, KodoCards mesure l’audience et analyse l’utilisation du site (pages consultées, parcours de navigation, fonctionnalités utilisées). Pour les utilisateurs connectés, ce traitement repose sur notre intérêt légitime à améliorer le service ; les données sont conservées en interne, ne sont ni revendues ni utilisées à des fins publicitaires, et vous pouvez vous y opposer à tout moment en nous écrivant à <a href="mailto:contact@kodocards.com">contact@kodocards.com</a>. Pour les visiteurs non connectés, cette mesure d’audience repose sur votre consentement (cookies statistiques), que vous pouvez retirer à tout moment. Les données de mesure d’audience sont conservées pour une durée maximale de 25 mois.</p>
