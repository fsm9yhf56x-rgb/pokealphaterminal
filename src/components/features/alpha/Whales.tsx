    ...
    <div className="rh" style={{ display:'flex', alignItems:'center', gap:'12px', padding:'13px 16px', borderBottom:last?'none':`1px solid ${SNOW.borderSoft}`, transition:'background .12s', animation:`rowIn .4s cubic-bezier(.16,1,.3,1) ${stagger}ms both` }}>
      ...
      <div style={{ flex:1, minWidth:0 }}>
        <div style={{ display:'flex', alignItems:'center', gap:'7px', marginBottom:'3px', flexWrap:'wrap' }}>
          ...
          {move.signal && <span style={{ display:'inline-flex', alignItems:'center', gap:'3px', fontSize:'8px', fontWeight:700, background:SNOW.redLight, color:SNOW.red, border:'1px solid #FFD8D0', padding:'2px 6px', borderRadius:'5px', fontFamily:FONT.display, letterSpacing:'.03em' }}>⚡ SIGNAL NORI</span>}
        </div>
    ...
    <>
      ...
      <div style={{ animation:'fadeIn 0.25s ease-out', width:'100%' }}>
        ...
        <div style={{ display:'flex', gap:'10px', flexWrap:'wrap', marginBottom:'22px' }}>
          ...
          <StatCard label="Signaux Nori" value={globalStats.signals} sub="moves convertis en alpha" color={SNOW.red} delay={120} />
