...
const DEALS = [
  { name:'Blissey V Alt Art',    set:'Chilling Reign', fair:180,listed:128,gap:28,conf:81,source:'eBay',lang:'EN',signal:'S' as const,psa:null,  vol:34,trend:12.4,why:'PSA Pop tr\u00e8s faible, Alt Art populaire, momentum acheteur',img:'https://assets.tcgdex.net/en/swsh/swsh6/183/high.webp' },
  { name:'Espeon VMAX Alt Art',  set:'Evolving Skies', fair:420,listed:318,gap:24,conf:74,source:'CM',  lang:'JP',signal:'A' as const,psa:1240, vol:56,trend:8.5, why:'Version JP toujours sous-cot\u00e9e vs EN, set Eevee en hausse',img:'https://assets.tcgdex.net/en/swsh/swsh7/270/high.webp' },
  ...
  { name:'Ditto V Alt Art',      set:'Fusion Strike',  fair:95, listed:74, gap:22,conf:61,source:'eBay',lang:'JP',signal:'B' as const,psa:null,  vol:18,trend:4.3, why:'Alt Art rare, sous-\u00e9valu\u00e9 vs Gengar du m\u00eame set',img:'https://assets.tcgdex.net/en/swsh/swsh8/235/high.webp' },
  { name:'Vaporeon VMAX Alt Art',set:'Evolving Skies', fair:240,listed:188,gap:22,conf:68,source:'CM',  lang:'EN',signal:'B' as const,psa:2100, vol:29,trend:5.8, why:'Trio Eevee OG en hausse, Vaporeon en retard sur le groupe',img:'https://assets.tcgdex.net/en/swsh/swsh7/172/high.webp' },
  { name:'Mew VMAX Alt Art',     set:'Fusion Strike',  fair:185,listed:148,gap:20,conf:65,source:'eBay',lang:'EN',signal:'B' as const,psa:null,  vol:67,trend:9.1, why:'Mew iconique, Fusion Strike sous-cot\u00e9 globalement',img:'https://assets.tcgdex.net/en/swsh/swsh8/269/high.webp' },
  { name:'Sylveon VMAX Alt Art', set:'Evolving Skies', fair:340,listed:278,gap:18,conf:63,source:'CM',  lang:'FR',signal:'B' as const,psa:null,  vol:22,trend:3.8, why:'Version FR rare, premium fran\u00e7ais pas encore pric\u00e9',img:'https://assets.tcgdex.net/en/swsh/swsh7/212/high.webp' },
]
