...
const DEALS = [
  ...
  { name:'Vaporeon VMAX Alt Art',set:'Evolving Skies', fair:240,listed:188,gap:22,conf:68,source:'CM',  lang:'EN',signal:'B' as const,psa:2100, vol:29,trend:5.8, why:'Trio Eevee OG en hausse, Vaporeon en retard sur le groupe',img:'/img/cards/vaporeon-vmax-alt.webp' },
  { name:'Mew VMAX Alt Art',     set:'Fusion Strike',  fair:185,listed:148,gap:20,conf:65,source:'eBay',lang:'EN',signal:'B' as const,psa:null,  vol:67,trend:9.1, why:'Mew iconique, Fusion Strike sous-cot\u00e9 globalement',img:'/img/cards/mew-vmax-alt.webp' },
  { name:'Sylveon VMAX Alt Art', set:'Evolving Skies', fair:340,listed:278,gap:18,conf:63,source:'CM',  lang:'FR',signal:'B' as const,psa:null,  vol:22,trend:3.8, why:'Version FR rare, premium fran\u00e7ais pas encore pric\u00e9',img:'/img/cards/sylveon-vmax-alt.webp' },
]
    ...
    <div style={{animation:'fadeIn .25s ease-out',width:'100%'}}>
      ...
      {best&&(
        <div style={{background:'linear-gradient(135deg,#111 0%,#1a1a1f 100%)',borderRadius:16,padding:'22px 26px',marginBottom:20,display:'flex',alignItems:'center',gap:24,animation:'slideUp .35s ease-out',cursor:'pointer',transition:'transform .2s',position:'relative',overflow:'hidden'}}
          ...
          <img src={best.img} alt="" style={{width:72,height:100,objectFit:'cover',borderRadius:8,border:'2px solid rgba(255,255,255,.1)',flexShrink:0}} onError={e=>{(e.target as HTMLImageElement).src='/img/cards/card-back.svg'}}/>
          <div style={{flex:1}}>
