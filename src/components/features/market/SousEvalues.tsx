...
const DEALS = [
  { name:'Blissey V Alt Art',    set:'Chilling Reign', fair:180,listed:128,gap:28,conf:81,source:'eBay',lang:'EN',signal:'S' as const,psa:null,  vol:34,trend:12.4,why:'PSA Pop tr\u00e8s faible, Alt Art populaire, momentum acheteur',img:'https://images.pokemontcg.io/swsh6/183_hires.png' },
  { name:'Espeon VMAX Alt Art',  set:'Evolving Skies', fair:420,listed:318,gap:24,conf:74,source:'CM',  lang:'JP',signal:'A' as const,psa:1240, vol:56,trend:8.5, why:'Version JP toujours sous-cot\u00e9e vs EN, set Eevee en hausse',img:'https://images.pokemontcg.io/swsh7/270_hires.png' },
  { name:'Glaceon VMAX Alt Art', set:'Evolving Skies', fair:260,listed:198,gap:24,conf:69,source:'eBay',lang:'EN',signal:'A' as const,psa:null,  vol:41,trend:6.2, why:'Momentum Eevee set, Glaceon en retard vs Umbreon',img:'https://images.pokemontcg.io/swsh7/209_hires.png' },
  { name:'Leafeon VMAX Alt Art', set:'Evolving Skies', fair:310,listed:241,gap:22,conf:72,source:'CM',  lang:'EN',signal:'B' as const,psa:null,  vol:38,trend:7.1, why:'Set complet Eevee, toutes les \u00e9volutions montent',img:'https://images.pokemontcg.io/swsh7/205_hires.png' },
  { name:'Ditto V Alt Art',      set:'Fusion Strike',  fair:95, listed:74, gap:22,conf:61,source:'eBay',lang:'JP',signal:'B' as const,psa:null,  vol:18,trend:4.3, why:'Alt Art rare, sous-\u00e9valu\u00e9 vs Gengar du m\u00eame set',img:'https://images.pokemontcg.io/swsh8/235_hires.png' },
  { name:'Vaporeon VMAX Alt Art',set:'Evolving Skies', fair:240,listed:188,gap:22,conf:68,source:'CM',  lang:'EN',signal:'B' as const,psa:2100, vol:29,trend:5.8, why:'Trio Eevee OG en hausse, Vaporeon en retard sur le groupe',img:'https://images.pokemontcg.io/swsh7/172_hires.png' },
  { name:'Mew VMAX Alt Art',     set:'Fusion Strike',  fair:185,listed:148,gap:20,conf:65,source:'eBay',lang:'EN',signal:'B' as const,psa:null,  vol:67,trend:9.1, why:'Mew iconique, Fusion Strike sous-cot\u00e9 globalement',img:'https://images.pokemontcg.io/swsh8/269_hires.png' },
  { name:'Sylveon VMAX Alt Art', set:'Evolving Skies', fair:340,listed:278,gap:18,conf:63,source:'CM',  lang:'FR',signal:'B' as const,psa:null,  vol:22,trend:3.8, why:'Version FR rare, premium fran\u00e7ais pas encore pric\u00e9',img:'https://images.pokemontcg.io/swsh7/212_hires.png' },
]
