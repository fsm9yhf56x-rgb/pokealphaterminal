                            ...
                            {cardImgs.map((item,ci)=>{
                              ...
                              <div key={card.id} className="shelf-card"
                                ...
                                <div style={{ padding:'6px 6px 4px', position:'relative' }}>
                                  ...
                                  {(()=>{ const p = card.curPrice > 0 ? card.curPrice : getPrice(card); return p ? <div style={{ fontSize:'10px', fontWeight:600, color:SNOW.ink, fontFamily:'var(--font-data)', marginTop:'1px' }}>{p.toLocaleString('fr-FR',{minimumFractionDigits:2,maximumFractionDigits:2})} {String.fromCharCode(8364)}</div> : null })()}
