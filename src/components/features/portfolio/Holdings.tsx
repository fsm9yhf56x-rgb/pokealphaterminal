...
export function Holdings() {
  ...
  const [activeSet,   setActiveSet]   = useState<string>('Toutes')
  ...
  return (
    <>
      <style>{`
        ...
        .card-body.rem { animation:slideUp2 .55s cubic-bezier(.4,0,.6,1) forwards;pointer-events:none; }
      ...
      <div style={{ background:'#070503', minHeight:'100vh', borderRadius:'16px', overflow:'hidden', position:'relative' }}>
        ...
        {spotCard&&(()=>{
          ...
          return(
            <div style={{ position:'fixed', inset:0, background:'rgba(0,0,0,.82)', zIndex:40, display:'flex', alignItems:'center', justifyContent:'center', padding:'32px' }} onClick={()=>setSpotCard(null)}>
              ...
              <div style={{ position:'relative', padding:'22px 22px 18px' }}>
                <div style={{ display:'flex', alignItems:'flex-start', justifyContent:'space-between', marginBottom:'12px' }}>
                  <div>
                    ...
                    <div style={{ fontSize:'14px', fontWeight:500, color:'rgba(255,255,255,.7)', fontFamily:'var(--font-display)', marginTop:'3px' }}>{activeSet==='Toutes'?'Tous les binders':activeSet}</div>
