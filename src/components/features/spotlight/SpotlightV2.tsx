...
export function SpotlightV2({ cardId, lang, portfolio }: SpotlightV2Props) {
  ...
  return (
    <div style={{
      ...
      <div style={{ position: 'absolute' as const, top: '2%', left: '-12%', width: '55%', height: '40%', background: 'radial-gradient(circle, rgba(255,165,80,0.38) 0%, transparent 70%)', filter: 'blur(72px)', pointerEvents: 'none' as const, zIndex: 0, animation: 'kcHaloDrift 18s ease-in-out infinite' }} />
      <div style={{ position: 'absolute' as const, top: '25%', right: '-8%', width: '50%', height: '35%', background: 'radial-gradient(circle, rgba(110,150,255,0.34) 0%, transparent 70%)', filter: 'blur(78px)', pointerEvents: 'none' as const, zIndex: 0, animation: 'kcHaloDrift 24s ease-in-out infinite reverse' }} />
      ...
      <div style={{ position: 'absolute' as const, bottom: '15%', left: '5%', width: '40%', height: '35%', background: 'radial-gradient(circle, rgba(255,90,140,0.18) 0%, transparent 70%)', filter: 'blur(80px)', pointerEvents: 'none' as const, zIndex: 0, animation: 'kcHaloDrift 32s ease-in-out infinite' }} />
