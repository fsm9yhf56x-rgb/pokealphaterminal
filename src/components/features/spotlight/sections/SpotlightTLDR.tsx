...
export function SpotlightTLDR({ prices }: Props) {
  ...
  return (
    <div className="kc-section-card" style={{ padding: '12px 16px', background: 'rgba(255,255,255,0.45)', backdropFilter: 'blur(28px) saturate(200%)', WebkitBackdropFilter: 'blur(28px) saturate(200%)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.55)', boxShadow: '0 4px 24px rgba(0,0,0,0.04), 0 1px 3px rgba(0,0,0,0.03), inset 0 1px 0 rgba(255,255,255,0.95), inset 0 -1px 0 rgba(255,255,255,0.4)', display: 'flex', gap: 12, alignItems: 'flex-start' }}>
