...
const ITEMS: CultureDailyItem[] = [
  ...
  { kind: 'anecdote', eyebrow: 'Anecdote du jour', title: 'Le Dracaufeu Shadowless',
    text: 'Les toutes premieres impressions du Set de Base, sans ombre sous l\u2019illustration. Un detail qui multiplie la cote par dix.',
  ...
  { kind: 'ere', eyebrow: 'Ere a (re)decouvrir', title: 'Diamant & Perle',
    text: '2007-2011 : une periode discrete qui devient le prochain vintage. Les connaisseurs s\u2019y positionnent deja.',
